...
def classify_category(title):
    categories = {
        "エンタメ": ["映画", "ドラマ", "アニメ", "舞台", "ミュージカル", "ライブ", "コンサート",
    "アイドル", "俳優", "女優", "芸能", "お笑い", "タレント", "テレビ", "バラエティ",
    "YouTuber", "声優", "歌手", "音楽番組", "レッドカーペット", "グラミー賞",
    "エンターテインメント", "芸術", "ダンス", "CM", "音楽", "興行収入"],
        "スポーツ": ["野球", "サッカー", "テニス", "バスケット", "バレー", "バレーボール",
    "ラグビー", "卓球", "柔道", "フィギュア", "マラソン", "ゴルフ", "陸上", "体操",
    "競泳", "eスポーツ", "スタジアム", "リーグ", "W杯", "五輪", "オリンピック",
    "ワールドカップ", "選手", "試合", "代表戦", "大会", "スポーツ", "監督", "コーチ"],
